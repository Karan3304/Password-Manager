            ...
            <div className="p-3 md:mycontainer min-h-[82.5vh]">
                ...
                <div className="text-black flex flex-col p-4 gap-8 items-center ">
                    ...
                    <div className="flex flex-col md:flex-row w-full justify-between gap-8">
                        ...
                        <input value={form.username} onChange={handleChange} placeholder='Enter Usename' className='rounded-full border border-green-500 w-full p-4 py-1' type="text" name='username' id='username' />

                        <div className="relative">
                            <input ref={passwordRef} value={form.password} onChange={handleChange} placeholder='Enter Password' className='rounded-full border border-green-500 w-full p-4 py-1' type="password" name='password' id='password' />
                            <span className='absolute right-[3px] top-[4px] cursor-pointer' onClick={showPassword}>
                                <img ref={ref} className='p-1' width={26} src="assets/eye.png" alt="eye" />
                            </span>
                        </div>
